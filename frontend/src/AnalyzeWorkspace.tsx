...
export function AnalyzeWorkspace({ phase, token, onChanged }: AnalyzeWorkspaceProps) {
  ...
  const canValidate = criteria.length > 0 && completed === required.length && phase.status !== 'VALIDATED';
